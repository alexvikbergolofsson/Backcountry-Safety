...
- **Focus:** 2m grid overlay implementation, AI Guide chat persona following the SAFETY_POLICY.md.
...
- **Mission:** Technical Lead. Enforce Safety Policy on every PR.
- **Focus:** Automated linting for "Safe" terminology and logical data separation.

# Global Autonomy & Security Policy

- **Workspace Lock:** All agents are strictly prohibited from reading or writing files outside of `./Backcountry-Safety`.
